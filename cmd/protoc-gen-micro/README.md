...
```
go get github.com/ycxwi/micro/v3/cmd/protoc-gen-micro@master
```
...
The proto generates a `RegisterGreeterHandler` function with a [api.Endpoint](https://godoc.org/github.com/ycxwi/micro/v3/service/api#Endpoint). 
