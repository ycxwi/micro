...
import (
	...
	authSrv "github.com/ycxwi/micro/v3/service/auth/client"
	"github.com/ycxwi/micro/v3/service/broker"
	brokerSrv "github.com/ycxwi/micro/v3/service/broker/client"
	"github.com/ycxwi/micro/v3/service/client"
	grpcCli "github.com/ycxwi/micro/v3/service/client/grpc"
	"github.com/ycxwi/micro/v3/service/events"
	eventsSrv "github.com/ycxwi/micro/v3/service/events/client"
	"github.com/ycxwi/micro/v3/service/metrics"
	noopMet "github.com/ycxwi/micro/v3/service/metrics/noop"
	"github.com/ycxwi/micro/v3/service/network"
	mucpNet "github.com/ycxwi/micro/v3/service/network/mucp"
	"github.com/ycxwi/micro/v3/service/registry"
	registrySrv "github.com/ycxwi/micro/v3/service/registry/client"
	"github.com/ycxwi/micro/v3/service/router"
	routerSrv "github.com/ycxwi/micro/v3/service/router/client"
	"github.com/ycxwi/micro/v3/service/runtime"
	runtimeSrv "github.com/ycxwi/micro/v3/service/runtime/client"
	"github.com/ycxwi/micro/v3/service/server"
	grpcSvr "github.com/ycxwi/micro/v3/service/server/grpc"
	"github.com/ycxwi/micro/v3/service/store"
	storeSrv "github.com/ycxwi/micro/v3/service/store/client"
)
