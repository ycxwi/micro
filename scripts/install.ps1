...
$releases = Invoke-RestMethod -Headers $githubHeader -Uri "https://api.github.com/ycxwi/${GitHubOrg}/${GitHubRepo}/releases" -Method Get
if ($releases.Count -eq 0) {
    throw "No releases found in github.com/ycxwi/micro repo"
}
