...
func testRunParentFolder(t *T) {
	...
	gomod := exec.Command("go", "mod", "edit", "-replace", "github.com/ycxwi/micro/v3=github.com/ycxwi/micro/v3@v3.0.0")
...
func testRunNewWithGit(t *T) {
	...
	if _, err := f.WriteString("\nreplace github.com/ycxwi/micro/v3 => github.com/ycxwi/micro/v3 master"); err != nil {
		t.Fatal(string(outp))
		return
	}
