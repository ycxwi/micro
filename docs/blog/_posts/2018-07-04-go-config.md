...
[**Go Config**](https://github.com/ycxwi/go-config) is a pluggable config framework which looks to solve these problems.
...
[readme](https://github.com/ycxwi/go-config) for details.
