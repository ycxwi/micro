...
built out the services needed so you should be able to access them in [ycxwi/services/blog](https://github.com/ycxwi/services/tree/master/blog).
...
$ micro run github.com/ycxwi/services/blogs/tags
$ micro run github.com/ycxwi/services/blogs/posts
```
...
For a comprehensive list of commands, please refer to the readmes in the [`posts`](https://github.com/ycxwi/services/tree/master/blog/posts) and [`tags`](https://github.com/ycxwi/services/tree/master/blog/tags) folders.
