...
For those who prefer action to words, the [getting started guide](https://m3o.com/docs/getting-started.html)! can give a taste of what the `micro server` is about or visit the project on [github](https://github.com/ycxwi/micro).
...
Also check out the project on [github](https://github.com/ycxwi/micro) and give us a тн?if you like it.
