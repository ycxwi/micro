...
---
<br>
This is a high level guide to writing microservices with [**go-micro**](https://github.com/ycxwi/go-micro).
...
and if you want to know more about [**Micro**](https://github.com/ycxwi/micro), the microservice toolkit, look [here]({{ site.baseurl }}/2016/03/20/micro.html).
...
Hopefully this blog post has been a helpful high level guide into writing microservices with [**Go Micro**](https://github.com/ycxwi/go-micro). 
