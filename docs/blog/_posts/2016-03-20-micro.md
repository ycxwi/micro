...
In this blog post we're going to discuss <b>[Micro](https://github.com/ycxwi/micro)</b>, an open source microservices toolkit. 
...
solve for other languages via HTTP using a [Sidecar](https://github.com/ycxwi/micro/tree/master/car). 
...
<b>[Micro](https://github.com/ycxwi/micro)</b> is a microservice toolkit, which will enable the creation of a 
...
Enter the [**Sidecar**](https://github.com/ycxwi/micro/tree/master/car), a lightweight companion service which is 
conceptually â€œattachedâ€?to the main (aka Parent) application and complements it by providing the features of the 
...
<a href="https://github.com/ycxwi/micro/tree/master/car"><i class="fab fa-github fa-2x"></i> sidecar</a>
...
The [**API**](https://github.com/ycxwi/micro/tree/master/api) provides a single entry point to query microservices 
...
the service to route requests to. HTTP requests are then converted to an [api.Request](https://github.com/ycxwi/micro/blob/master/api/proto/api.proto) 
...
An example of how to create an API service can be found here. [Greeter API](https://github.com/ycxwi/micro/blob/master/examples/greeter/api/api.go)
...
<a href="https://github.com/ycxwi/micro/tree/master/api"><i class="fab fa-github fa-2x"></i> api</a>
...
<a href="https://github.com/ycxwi/micro/tree/master/web"><i class="fab fa-github fa-2x"></i> web</a>
...
<a href="https://github.com/ycxwi/micro/tree/master/cli"><i class="fab fa-github fa-2x"></i> cli</a>
