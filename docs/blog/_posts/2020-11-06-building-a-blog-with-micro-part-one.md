...
the [store](https://micro.dev/reference#store) and the [model](https://github.com/ycxwi/dev/tree/master/model).
...
The above piece of code uses the [model package](https://github.com/ycxwi/dev/tree/master/model). It sets up the indexes which will enable us to query the data and also tells model to maintain these indexes.
...
The source code for this can be found [here](https://github.com/ycxwi/dev/tree/master/blog/v1-posts).
