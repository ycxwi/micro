...
Read on to learn more or go straight to the [latest release](https://github.com/ycxwi/micro/releases/latest). 
...
[micro](https://github.com/ycxwi/micro) and [go-micro](https://github.com/micro/go-micro)? It's a good 
...
```go
import "github.com/ycxwi/micro/v3/service/config"
...
See the [micro/client/sdk](https://github.com/ycxwi/micro/tree/master/client/sdk) directory for the generated clients. These will be 
