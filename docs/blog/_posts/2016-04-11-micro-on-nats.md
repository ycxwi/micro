...
---
<br>
In this post we're going to discuss using [**Micro**](https://github.com/ycxwi/micro) on [**NATS**](http://nats.io/). 
...
[**Micro**](https://github.com/ycxwi/micro) is a microservice toolkit built with a pluggable architecture allowing the underlying dependencies to be swapped out with 
