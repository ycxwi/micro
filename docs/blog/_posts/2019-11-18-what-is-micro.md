...
[**Micro**](https://github.com/ycxwi/micro) is an open source project focused on simplifying microservices development. 
...
In that [**Micro**](https://github.com/ycxwi/micro) was born. Micro was built as a toolkit to enable the development of 
...
[Micro](https://github.com/ycxwi/micro) has also progressed significantly as we've moved on from just a sparse set of tools to 
