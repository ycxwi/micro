...
[**Micro**](https://github.com/ycxwi/micro), the microservice toolkit, includes a number of services which provide entry points into your 
...
```go
import "github.com/ycxwi/micro/bot/command"
...
```go
import "github.com/ycxwi/micro/bot/input"
...
We're doing just that in the Micro ecosystem by including a bot as part of the [Micro toolkit](https://github.com/ycxwi/micro).
