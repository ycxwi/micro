...
---
<br>
Micro started it's journey as [**go-micro**](https://github.com/ycxwi/go-micro) - a microservices framework - focused 
...
this in a way that was true to go-micro itself. This led to the creation of [**micro**](https://github.com/ycxwi/micro), 
...
In the past few weeks we've realised [**go-micro**](https://github.com/ycxwi/go-micro) was really the focal point for most of our users 
...
We're not forgetting about [**micro**](https://github.com/ycxwi/micro) either though. In our minds after you've built your microservices 
...
<h6><a href="https://github.com/ycxwi/micro"><i class="fab fa-github fa-2x"></i> Micro</a></h6>
