...
Micro is a pluggable toolkit and framework. The internal features can be swapped out with any [go-plugins](https://github.com/ycxwi/go-plugins).

The toolkit has a separate plugin interface. Learn more at [micro/plugin](https://github.com/ycxwi/micro/tree/master/plugin).
...
The go-micro plugins can be found in [github.com/micro/go-plugins](https://github.com/ycxwi/go-plugins).
