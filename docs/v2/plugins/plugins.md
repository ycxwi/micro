...
There's already dozens of plugins which are available at [github.com/ycxwi/go-plugins](https://github.com/micro/go-plugins). 
...
The open source plugins can be found at [github.com/ycxwi/go-plugins](https://github.com/micro/go-plugins).
