...
This is a more detailed guide to writing a service and the internals related to it. The top level [Service](https://pkg.go.dev/github.com/ycxwi/go-micro/v2#Service) 
...
```go
import "github.com/ycxwi/go-micro/v2"
...
All the available options can be found [here](https://pkg.go.dev/github.com/ycxwi/go-micro/v2#Option).
...
[here](https://pkg.go.dev/github.com/ycxwi/go-micro/v2/config/cmd#pkg-variables).
...
- [protoc-gen-micro](https://github.com/ycxwi/micro/tree/master/cmd/protoc-gen-micro)
...
other services. A quick getting started for that is [here](https://github.com/ycxwi/go-micro#getting-started).

## Writing a Client

The [client](https://pkg.go.dev/github.com/ycxwi/go-micro/v2/client) package is used to query services. When you create a 
