...
The top level [Function](https://pkg.go.dev/github.com/ycxwi/go-micro/v2#Function) interface is the main component for the 
...
[here](https://pkg.go.dev/github.com/ycxwi/go-micro/v2/cmd#pkg-variables).
...
to query it. A quick getting started for that is [here](https://github.com/ycxwi/go-micro#getting-started).

## Writing a Client

The [client](https://pkg.go.dev/github.com/ycxwi/go-micro/v2/client) package is used to query functions and services. When you create a 
