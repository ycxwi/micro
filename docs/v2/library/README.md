...
[github.com/ycxwi/go-plugins](https://github.com/micro/go-plugins).
...
Discovery is pluggable. Find plugins for consul, kubernetes, zookeeper and more in the [ycxwi/go-plugins](https://github.com/micro/go-plugins) repo.
