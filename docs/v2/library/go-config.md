...
- [cli](https://github.com/ycxwi/go-micro/tree/master/config/source/cli) - read from parsed CLI flags
- [consul](https://github.com/ycxwi/go-micro/tree/master/config/source/consul) - read from consul
- [env](https://github.com/ycxwi/go-micro/tree/master/config/source/env) - read from environment variables
- [etcd](https://github.com/ycxwi/go-micro/tree/master/config/source/etcd) - read from etcd v3
- [file](https://github.com/ycxwi/go-micro/tree/master/config/source/file) - read from file
- [flag](https://github.com/ycxwi/go-micro/tree/master/config/source/flag) - read from flags
- [memory](https://github.com/ycxwi/go-micro/tree/master/config/source/memory) - read from memory
...
```go
import "github.com/ycxwi/go-micro/v2/config"
...
```go
import (
	"github.com/ycxwi/go-micro/v2/config"
)
...
import (
	"github.com/ycxwi/go-micro/v2/config"
	"github.com/ycxwi/go-micro/v2/config/source/file"
)
