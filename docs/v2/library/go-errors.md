...
[errors.InternalServerError](https://pkg.go.dev/github.com/ycxwi/go-micro/v2/errors#InternalServerError) where somethin has 
gone wrong internally and [errors.Timeout](https://pkg.go.dev/github.com/ycxwi/go-micro/v2/errors#Timeout) where a timeout occurred.
