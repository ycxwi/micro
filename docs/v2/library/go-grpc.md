...
Our gRPC service makes use of [go-micro](https://github.com/ycxwi/go-micro) plugins to create a simpler framework for gRPC development. It interoperates with 
