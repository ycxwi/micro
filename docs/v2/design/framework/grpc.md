...
Our [client](https://github.com/ycxwi/go-plugins/tree/master/client/grpc) and [server](https://github.com/ycxwi/go-plugins/tree/master/server/grpc) 
...
Our [transport](https://github.com/ycxwi/go-plugins/tree/master/transport/grpc) implementation can be found here.
