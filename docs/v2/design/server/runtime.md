...
- [go-micro/runtime](https://github.com/ycxwi/go-micro/tree/master/runtime) - a language agnostic runtime interface
- [micro/runtime](https://github.com/ycxwi/micro/tree/master/runtime) - an rpc service which overlays the interface
...
- Go Micro - we can pull go from source or via the ycxwi/go-micro docker image
