...
- **Service Proxy:** A transparent proxy built on [Go Micro](https://github.com/ycxwi/go-micro) and the [MUCP](https://github.com/micro/protocol) 
...
```shell
go get github.com/ycxwi/micro/v2
```
...
Micro uses the [go-micro](https://github.com/ycxwi/go-micro) registry interface for service discovery. Multicast DNS is the default 
...
go get github.com/ycxwi/micro/v2/cmd/protoc-gen-micro@master
```

See [protoc-gen-micro](https://github.com/ycxwi/micro/tree/master/cmd/protoc-gen-micro) for more details.

## Writing a service

Micro includes new template generation to speed up writing applications

For full details on writing services see [**go-micro**](https://github.com/ycxwi/go-micro).
...
Micro is built on [go-micro](https://github.com/ycxwi/go-micro) making it a pluggable toolkit.
