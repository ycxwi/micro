...
```
micro run github.com/ycxwi/foo
```

Status

```
micro run -s github.com/ycxwi/foo
```

Kill

```
micro run -k github.com/ycxwi/foo
```
...
```
micro run -x github.com/ycxwi/foo
```

Run and restart on death

```
micro run -r github.com/ycxwi/foo
```

Run and update source on fetch

```
micro run -u github.com/ycxwi/foo
```
