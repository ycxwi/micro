...
```go
import "github.com/ycxwi/go-micro/v2/agent/command"
...
```go
import "github.com/ycxwi/go-micro/v2/agent/input"
...
The service interface is as follows and can be found at [go-bot/proto](https://github.com/ycxwi/go-micro/agent/blob/master/proto/bot.proto)
...
import (
	...
	proto "github.com/ycxwi/go-micro/v2/agent/proto"
)
