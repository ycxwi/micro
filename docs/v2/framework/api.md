...
[go-micro](https://github.com/ycxwi/go-micro), leveraging it for service discovery, load balancing, encoding and RPC based communication.
...
```shell
go get -u github.com/ycxwi/micro/v2
```
