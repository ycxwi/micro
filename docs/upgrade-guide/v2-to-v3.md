...
As part of v3 we've simplified the development model and consolidated the micro and go-micro libraries. This means that you, as the developer, only need to worry about leveraging the libraries offered in micro. Users of the now deprecated [go-micro](https://github.com/ycxwi/go-micro) framework can follow this guide to upgrade their projects to use Micro v3.
...
In go-micro, modules such as config could only be accessed via the service object, for example `srv.Options().Config.Read()`. In Micro this has been made easier by providing public functions in each package which can be accessed by importing any package, nested within "github.com/ycxwi/micro/v3/service". Here is an example of how you can load config in Micro:
...
* [Auth](https://github.com/ycxwi/micro/tree/master/service/auth)
* [Broker](https://github.com/ycxwi/micro/tree/master/service/broker)  
* [Client](https://github.com/ycxwi/micro/tree/master/service/client)
* [Config](https://github.com/ycxwi/micro/tree/master/service/config)
* [Context](https://github.com/ycxwi/micro/tree/master/service/context)
* [Errors](https://github.com/ycxwi/micro/tree/master/service/errors)
* [Logger](https://github.com/ycxwi/micro/tree/master/service/logger)
* [Store](https://github.com/ycxwi/micro/tree/master/service/store)
