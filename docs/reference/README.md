...
```sh
# MacOS
curl -fsSL https://raw.githubusercontent.com/ycxwi/micro/master/scripts/install.sh | /bin/bash

# Linux
wget -q  https://raw.githubusercontent.com/ycxwi/micro/master/scripts/install.sh -O - | /bin/bash

# Windows
powershell -Command "iwr -useb https://raw.githubusercontent.com/ycxwi/micro/master/scripts/install.ps1 | iex"
```
...
At this point it is useful to have a look at the proto of the [registry service here](https://github.com/ycxwi/micro/blob/master/proto/registry/registry.proto).
...
interfaces for each can be found in [micro/proto/auth](https://github.com/ycxwi/micro/blob/master/proto/auth/auth.proto) 
and the Go library, client and server implementations in [micro/service/auth](https://github.com/ycxwi/micro/tree/master/service/auth).
...
The [config interface](https://github.com/ycxwi/micro/blob/master/service/config/config.go) specifies not
...
```go
import "github.com/ycxwi/micro/v3/service/store"
...
import (
	...
	"github.com/ycxwi/micro/v3/profile"
	"github.com/ycxwi/micro/v3/service/store"
	"github.com/ycxwi/micro/v3/service/store/memory"
)
...
go mod edit -replace github.com/ycxwi/micro/profile/staging/v3=./profile/staging
go mod tidy
