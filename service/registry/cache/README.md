...
Cache is a library that provides a caching layer for the go-micro [registry](https://godoc.org/github.com/ycxwi/go-micro/registry#Registry).
...
```go
import "github.com/ycxwi/go-micro/registry/cache"
