...
//
// Original source: github.com/ycxwi/go-micro/v3/api/router/router_test.go
package router_test
...
import (
	...
	"github.com/ycxwi/micro/v3/service/api/handler"
	"github.com/ycxwi/micro/v3/service/api/handler/rpc"
	"github.com/ycxwi/micro/v3/service/api/router"
	rregistry "github.com/ycxwi/micro/v3/service/api/router/registry"

	//	rstatic "github.com/ycxwi/micro/v3/server/api/router/static"

	"github.com/ycxwi/micro/v3/service/client"
	gcli "github.com/ycxwi/micro/v3/service/client/grpc"
	rmemory "github.com/ycxwi/micro/v3/service/registry/memory"
	rt "github.com/ycxwi/micro/v3/service/router"
	regRouter "github.com/ycxwi/micro/v3/service/router/registry"
	"github.com/ycxwi/micro/v3/service/server"
	gsrv "github.com/ycxwi/micro/v3/service/server/grpc"
	pb "github.com/ycxwi/micro/v3/service/server/grpc/proto"
)
